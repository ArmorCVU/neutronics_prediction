...
parser.add_argument('--module', type=str, choices=valid_module_type, default='mlp')
parser.add_argument('--device', type=str, default='cuda:0')
args = parser.parse_args()
DEVICE = args.device

# only include CNN blocks and its correspond channels
valid_module_dict = {
...
print(f'Using module: {module_type} fitting FDH')

save_information = 'fit_dh.pkl'
tensorboard_information = f'fdh_no_one_hot_epoch300_conv'
