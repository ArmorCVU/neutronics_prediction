...
class _NetA(nn.Module):
    ...
    def __init__(self):
        ...
        self.hab = HABLayer(channel=128)  # Add HAB here
...
class _NetB(nn.Module):
    ...
    def forward(self, x):
        ...
        out = out + x
        out = self.group3(out)
        out = self.hab(out)  # Pass through HAB
        return out
...
class _NetC(nn.Module):
    ...
    def __init__(self):
        ...
        self.hab = HABLayer(channel=32)  # Add HAB here
...
class Model(nn.Module):
    ...
    def __init__(self, input_channel=13, num_inception_resnet=3, include_top=True): #num_inception_resnet为块的数量
        super().__init__()
        self.input_channel = input_channel
        self.num_inception_resnet = num_inception_resnet
        self.include_top = include_top
        incep_blocks = [_IncepResNet() for _ in range(num_inception_resnet)]
        #
        self.seq = Seq(
