...
# model
net = Model(input_channel=5, num_inception_resnet=3).to(DEVICE)
...
writer = utils.get_tensorboard_writer('fit_cbc_1128_hab')
...
torch.save(net.state_dict(), 'models/fit_cbc_1128_hab.pkl')