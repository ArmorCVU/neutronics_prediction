...
import utils
from model_no_HAB import Model
import numba
...
net = nn.Sequential(
    Model(include_top=False, num_inception_resnet=2, input_channel=5), #num的数量必须和训练时的数量对齐，否则会报错
    nn.Flatten(),
...
net.load_state_dict(torch.load('models/fit_fdh_0106_incp2_seed4.pkl'))
net.eval()
