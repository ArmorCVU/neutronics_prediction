...
# 定义不同形状的标记
markers = ['o', 's', '^', 'v', '<', '>', 'p', '*', '+', 'x']
labels = ['size 9×9 (57)', 'size 13×13 (121)', 'size 15×15 (157)', 'size 15×15 (177)'] #修改标签的名称
...
plt.ylabel('Loss of Variations (MSE)', fontsize=14)
plt.title('The Generalization of Diverse Reactor Sizes on $F_{\Delta H}$ Over Epochs', fontsize=16)
